...
CREATE TABLE `user_project` (
  ...
  CONSTRAINT `user_project_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`) ON DELETE CASCADE
...
(1,'Artemy Sychev','1qaz2wsx'),
(2,'Nikita Polyantsev','1qaz2wsx'),
(3,'Timofey Schipkov','1qaz2wsx'),
(4,'Vildan Khismatullin','1qaz2wsx'),
(5,'Andrey Demidov','1qaz2wsx'),
(6,'Daniil Sychev','1qaz2wsx');
...
-- Dump completed on 2024-01-12 14:00:06
